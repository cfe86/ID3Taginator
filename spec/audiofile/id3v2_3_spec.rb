...
RSpec.describe Id3Taginator::AudioFile do
  it 'creates full audio file id3v2.3 and writes/reads it correctly' do
    ...
    expect(audio_file.id3v2_tag).is_a?(Id3Taginator::Id3v23Tag)
  ...
  def write_id3v2_3_tag_mp3(input_file, output_file)
